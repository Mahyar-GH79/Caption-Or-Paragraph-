...
This repository contains the code for fine-tuning and evaluating vision-language models on image captioning and paragraph-level description tasks. The project investigates whether single captions or detailed paragraphs produce better image-text representations, using models like Qwen and LLaMA on datasets including COCO, Flickr30K, CC3M, and ShareGPT4V.
